...
class SASTask:
    ...
    def validate(self):
        ...
        A task is valid if all its components are valid. Valid domains
...
class SASOperator:
    ...
    def validate(self, variables):
        ...
        - It is currently not very clear what the semantics of operators
          ...
          To make our life simpler when generating SAS+ domains from
          PDDL domains, it probably makes most sense to generalize the
